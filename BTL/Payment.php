...
if (isset($_POST['btnDatTour'])) {
    ...
    $soNguoiLon = $_POST['nguoiLon'];
    $soTreEm = $_POST['treEm'];
    $ngayDi = $_POST['ngayDi'];
    $maGiamGia = $_POST['maGiamGia'];
    $tongTienLable = $_POST['tongTienLable'];

    echo "Họ tên: $name<br>";
    echo "Tuổi: $age<br>";
    echo "Email: $email1<br>";
    echo "SĐT: $phoneNumber<br>";
    echo "Số người lớn: $soNguoiLon<br>";
    echo "Số trẻ em: $soTreEm<br>";
    echo "Ngày đi: $ngayDi<br>";
    echo "Mã giảm giá: $maGiamGia<br>";
    echo "tong tien: $tongTienLable<br>";
        ...
        <div class="container">
            <div class="wrapper">
                <div class="arrow-steps clearfix" style="text-decoration: none;">
                    ...
                    <div class="step current"> <a href="./Payment.php"><span>Thanh Toán</span> </a></div>
